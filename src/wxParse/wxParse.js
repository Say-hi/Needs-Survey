...
function wxParseImgTap(e) {
  ...
  // console.log('nowImgUrl', nowImgUrl)
  // console.log('tagFrom', tagFrom)
  // console.log('that.data[tagFrom]', that.data[tagFrom])
  if (typeof (tagFrom) != 'undefined') {
    for (let [i, v] of that.data[tagFrom].imageUrls.entries()) {
      if (that.data[tagFrom].imageUrls[i].indexOf('http') < 0) {
        that.data[tagFrom].imageUrls[i] = 'http://120.78.221.80:8082' + v
      }
    }
